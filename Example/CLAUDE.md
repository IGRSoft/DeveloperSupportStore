...
- **Entitlements File**: `Config/DeveloperSupportStoreExample.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/DeveloperSupportStoreExample.entitlements`:
